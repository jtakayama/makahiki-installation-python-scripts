...
def run(logfile):
    ...
    try:
        ...
        USER_PROJECT_HOME = USER_HOME + os.sep + "makahiki" + os.sep + "makahiki"
        os.chdir(USER_PROJECT_HOME)
        update_output = subprocess.check_output(["echo \"Y\" | ./scripts/initialize_instance.py --type default"], stderr=subprocess.STDOUT, shell=True)
        ...
        closing = "\nMakahiki instance initialization script has completed.\n"
